...
// ponytail: lista plana ordenada por hora, sin agrupar. Sin hora van al final.
const sortedByTime = (events: PelotaEvent[]): PelotaEvent[] => [...events].sort((a, b) => timeToSortKey(a.time) - timeToSortKey(b.time));
